...
/* DVI.C will handle all SiI164 chip stuffs and try it best
 * to make code minimal and useful
 */
 ...
 *     -1   - Fail.
 */
long sii164InitChip(unsigned char edgeSelect, unsigned char busSelect,
		    unsigned char dualEdgeClkSelect, unsigned char hsyncEnable,
		    unsigned char vsyncEnable, unsigned char deskewEnable,
