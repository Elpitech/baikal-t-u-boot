...
int hw_copyarea(struct lynx_accel *accel,
		...
		unsigned int sBase,
		/* Pitch value of source surface in BYTE */
		unsigned int sPitch,
		/* Starting coordinate of source surface */
		unsigned int sx,
		unsigned int sy,
		/* Address of destination: offset in frame buffer */
		unsigned int dBase,
		/* Pitch value of destination surface in BYTE */
		unsigned int dPitch,
		/* Color depth of destination surface */
		unsigned int Bpp,
		/* Starting coordinate of destination surface */
		unsigned int dx,
		unsigned int dy,
		/* width and height of rectangle in pixel value */
		unsigned int width,
		unsigned int height,
		/* ROP value */
		unsigned int rop2)
{
	...
	/* If source and destination are the same surface, need to check
	 * for overlay cases
	 */
...
int hw_imageblit(struct lynx_accel *accel,
		 ...
		 const char *pSrcbuf,
		 /* Pitch value (in bytes) of the source buffer, +ive means
		  * top down and -ive mean button up
		  */
		 u32 srcDelta,
