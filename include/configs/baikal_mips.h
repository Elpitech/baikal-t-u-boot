...
#if defined(CONFIG_BAIKAL_ECC)
#define CONFIG_BAIKAL_FW uboot_baikal.fw.spd.ecc
#else
#define CONFIG_BAIKAL_FW uboot_baikal.fw.spd
#endif
#define CONFIG_SYS_SPD_BUS_NUM		1
#define CONFIG_BAIKAL_SPD_ADDRESS	0x50
#define SRAM_SPD_TIMER_OFF			0x2000
#define CONFIG_SRAM_SPD_TIMESTAMP	(CONFIG_SRAM_BASE + SRAM_SPD_TIMER_OFF)
#elif defined(CONFIG_BAIKAL_BFKX) /* BFKX board (BFK1.6 + Baikal-T1) */
#define CONFIG_BAIKAL_FW uboot_baikal.fw.bfkx
#elif defined(CONFIG_BAIKAL_MODULE) /* Module board */
#define CONFIG_BAIKAL_FW uboot_baikal.fw.MT41K512M16.noecc
#else /* BFK1.x boards & other devices */
#define CONFIG_BAIKAL_FW uboot_baikal.fw
...
#define CONFIG_BAIKAL_FW_DDR_HNDL_OFF	0x100
